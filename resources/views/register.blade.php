            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    <div class="password-field">
                        <input required type="password" name="password" id="password" placeholder="{{ __('Enter password') }}">
                ...
                <div class="input-box">
                    ...
                    <div class="password-field">
                        <input required type="password" name="password_confirmation" id="confirm_password" placeholder="{{ __('confirm password') }}">
                        <i class="fa-solid fa-eye-slash toggle-password"></i>
                    </div>
                    <div class="error-message" id="confirm_password-error">@error('password_confirmation') {{ $message }} @enderror</div>
                </div>
                ...
                <div class="input-box">
                    <span class="details"><i class="fab fa-whatsapp"></i> {{ __('messages.whatsapp') }}</span>
                    <input required type="tel" name="whatsapp_number" id="whatsapp_number" placeholder="{{ __('enter whatsapp number') }}" 
                            value="{{ old('whatsapp_number') }}">
                    <span class="error-whatsapp" id="whatsapp_number-error">@error('whatsapp_number') {{ $message }} @enderror</span>
                </div>
